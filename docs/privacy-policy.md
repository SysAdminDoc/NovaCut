...
registry state, AI usage ledger entries, fatal-crash breadcrumbs, and optional
...
local bundles, crash breadcrumbs are bounded, and memory-trim breadcrumbs are
bounded under the diagnostics directory.
