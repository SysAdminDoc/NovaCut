...
| P0.6 | Media3 modular UI/effect parity spike | 3 | 3 | 4 | 2 | 2 | Lottie adoption is complete where output parity holds; Player Compose was evaluated and full replacement rejected for 1.10.1; inspector-frame audit is complete with a policy gate for HDR/effect/custom-decoder frame extraction. |
...
6. Completed Media3 Lottie parity adoption, Media3 Compose Player non-adoption, and inspector-frame migration policy.
