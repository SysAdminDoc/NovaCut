...
| [R6.10](#r610--media3-110-modular-ui-adoption) | Adopt `media3-effect-lottie` module | Done for the Lottie portion: official Media3 renderer handles eligible exports, with fallback retained where Media3 would change output semantics. Remaining R6.10 work is UI/inspector audit only. |
