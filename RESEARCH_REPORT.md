...
- [Verified] The Active Queue's "Editor state storage migration" direction is
  ...
  AI storage into `EditorAiState`, the v3.74.22 / versionCode 159 pass moved
  export storage into `EditorExportDomainState`, the v3.74.23 / versionCode
  160 pass moved media feedback storage into `EditorMediaState`, the v3.74.24
  / versionCode 161 pass moved compound navigation storage into
  `EditorCompoundState`, and the v3.74.25 / versionCode 162 pass moved caption
  translation storage into `EditorCaptionState`, while preserving read-only
  compatibility accessors for existing UI and delegate reads.
